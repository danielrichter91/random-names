...
var elementRandomList = document.getElementById('random-list-here');
document.getElementById("random-name").addEventListener("click", function () {
  elementRandom.innerHTML = "single() > '".concat((0, _index.single)(), "'");
});
document.getElementById("random-male").addEventListener("click", function () {
  elementMale.innerHTML = "single('MALE') > '".concat((0, _index.single)('MALE'), "'");
});
document.getElementById("random-female").addEventListener("click", function () {
  elementFemale.innerHTML = "single('FEMALE') > '".concat((0, _index.single)('FEMALE'), "'");
});
document.getElementById("random-list").addEventListener("click", function () {
  elementRandomList.innerHTML = "list(5) > [".concat((0, _index.list)(5), "]");
});
elementRandom.innerHTML = "single() > '".concat((0, _index.single)(), "'");
elementMale.innerHTML = "single('MALE') > '".concat((0, _index.single)('MALE'), "'");
elementFemale.innerHTML = "single('FEMALE') > '".concat((0, _index.single)('FEMALE'), "'");
